...
WELCOME_SENTENCE = "欢迎使用基于yolov11的海底生物目标检测"   # 欢迎的句子
ICON_IMAGE = "images/UI/oo.png"                 # 系统logo界面
...
class MainWindow(QTabWidget):
    def __init__(self):
        ...
        self.model_path = "runs/final/weights/best.pt"  # todo 指明模型加载的位置的设备
    ...
    def initUI(self):
        ...
        self.img_num_label = QLabel("Detection Result：待检测")
        ...
        # todo 添加摄像头检测标签逻辑
        self.vid_num_label = QLabel("Detection Result：{}".format("等待检测"))
        ...
        self.model_label = QLabel("Detection Result：{}".format(self.model_path))
    ...
    def upload_img(self):
        ...
        if fileName: # 如果存在文件名称则对图像进行处理
            ...
            self.right_img.setPixmap(QPixmap(IMAGE_RIGHT_INIT))
            self.img_num_label.setText("Detection Result：待检测")
    ...
    def detect_img(self):
        ...
        self.img_num_label.setText("Detection Result\n{}".format(result_info))
            ...
            if success:
                ...
                if self.config_track_value.currentText() == "不开启追踪":
                    ...
                    for idx_cls, cls_num in enumerate(result_nums):
                        ...
                        # result_info = result_info + "{}:{}\n".format(result_names[idx_cls], cls_num)
                        # result_info = result_info + "{}:{}\n".format(result_names[idx_cls], cls_num)
                    self.vid_num_label.setText("Detection Result：\n{}".format(result_info))
                    vid_i = vid_i + 1
                else:
    ...
    def reset_vid(self):
        ...
        self.vid_num_label.setText("Detection Result：{}".format("等待检测"))   # 重新设置视频检测页面的文字内容
