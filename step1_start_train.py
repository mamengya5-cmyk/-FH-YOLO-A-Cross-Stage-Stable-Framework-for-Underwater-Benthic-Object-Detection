...
data_dir = os.path.join(parent_dir, "ultralytics/cfg/datasets/444-x.yaml")
# data_dir = os.path.join(parent_dir, "ultralytics/cfg/datasets/111-drive.yaml")
# ---------------------------------- 训练超参数配置  ------------------------------------------------------
...
# results = model.train(data=DATA_CONFIG_PATH, project="./runs-yuan/yolo11n_pretrained", epochs=EPOCHS, imgsz=IMAGE_SIZE, device=DEVICE, workers=WORKERS, batch=BATCH, cache=CACHE, amp=AMP)  # CPU 开始训练
...
# results = model.train(data=DATA_CONFIG_PATH, project="./runs-yuan/yolov10n_pretrained", epochs=EPOCHS, imgsz=IMAGE_SIZE, device=DEVICE, workers=WORKERS, batch=BATCH, cache=CACHE, amp=AMP)  # CPU 开始训练
# time.sleep(10) # 睡眠10s，主要是用于服务器多次训练的过程中使用
#
# model = YOLO("yolov8s.yaml").load("yolov8s.pt")
# results = model.train(data=DATA_CONFIG_PATH, project="./runs-yuan/yolo12n_pretrained", epochs=EPOCHS, imgsz=IMAGE_SIZE, device=DEVICE, workers=WORKERS, batch=BATCH, cache=CACHE, amp=AMP)  # CPU 开始训练
# time.sleep(10) # 睡眠10s，主要是用于服务器多次训练的过程中使用
#
#
# model = YOLO("yolov5n.yaml").load("yolov5n.pt")# load a pretrained model (recommended for training)
# results = model.train(data=DATA_CONFIG_PATH, project="./runs-yuan/yolov5n_pretrained", epochs=EPOCHS, imgsz=IMAGE_SIZE, device=DEVICE, workers=WORKERS, batch=BATCH, cache=CACHE, amp=AMP)  # CPU 开始训练
# time.sleep(10) # 睡眠10s，主要是用于服务器多次训练的过程中使用

#
model = YOLO("yolo12s.yaml").load("yolo12s.pt")# load a pretrained model (recommended for training)
results = model.train(data=DATA_CONFIG_PATH, project="./runs-yuan/yolo12s_pretrained", epochs=EPOCHS, imgsz=IMAGE_SIZE, device=DEVICE, workers=WORKERS, batch=BATCH, cache=CACHE, amp=AMP)  # CPU 开始训练
time.sleep(10) # 睡眠10s，主要是用于服务器多次训练的过程中使用


# model = YOLO("yolov8n.yaml").load("yolov8n.pt")# load a pretrained model (recommended for training)
# results = model.train(data=DATA_CONFIG_PATH, project="./runs-yuan/yolov8n_pretrained", epochs=EPOCHS, imgsz=IMAGE_SIZE, device=DEVICE, workers=WORKERS, batch=BATCH, cache=CACHE, amp=AMP)  # CPU 开始训练
# time.sleep(10) # 睡眠10s，主要是用于服务器多次训练的过程中使用




# model = YOLO("yolov5n.yaml")# load a pretrained model (recommended for training)
# results = model.train(data=DATA_CONFIG_PATH, project="./runs/yolov5n", epochs=EPOCHS, imgsz=IMAGE_SIZE, device=DEVICE, workers=WORKERS, batch=BATCH, cache=CACHE, amp=AMP)  # CPU 开始训练
# time.sleep(10) # 睡眠10s，主要是用于服务器多次训练的过程中使用
#
# model = YOLO("yolov8n.yaml")# load a pretrained model (recommended for training)
# results = model.train(data=DATA_CONFIG_PATH, project="./runs/yolov8n", epochs=EPOCHS, imgsz=IMAGE_SIZE, device=DEVICE, workers=WORKERS, batch=BATCH, cache=CACHE, amp=AMP)  # CPU 开始训练
# time.sleep(10) # 睡眠10s，主要是用于服务器多次训练的过程中使用
...
# results = model.train(data=DATA_CONFIG_PATH, project="./runs/yolov10s", epochs=EPOCHS, imgsz=IMAGE_SIZE, device=DEVICE, workers=WORKERS, batch=BATCH, cache=CACHE, amp=AMP)  # CPU 开始训练
# time.sleep(10) # 睡眠10s，主要是用于服务器多次训练的过程中使用
#
# model = YOLO("yolov10s-resnet.yaml")
# results = model.train(data=DATA_CONFIG_PATH, project="./runs/yolov10s-resnet", epochs=EPOCHS, imgsz=IMAGE_SIZE, device=DEVICE, workers=WORKERS, batch=BATCH, cache=CACHE, amp=AMP)  # CPU 开始训练
# time.sleep(10) # 睡眠10s，主要是用于服务器多次训练的过程中使用
#
# model = YOLO("yolov10s-resnet-cbam.yaml")
# results = model.train(data=DATA_CONFIG_PATH, project="./runs/yolov10s-resnet-cbam", epochs=EPOCHS, imgsz=IMAGE_SIZE, device=DEVICE, workers=WORKERS, batch=BATCH, cache=CACHE, amp=AMP)  # CPU 开始训练
# time.sleep(10) # 睡眠10s，主要是用于服务器多次训练的过程中使用
...
# model = YOLO("yolo12n-x-biformer.yaml")
